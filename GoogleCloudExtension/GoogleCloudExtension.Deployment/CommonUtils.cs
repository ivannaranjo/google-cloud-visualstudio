...
namespace GoogleCloudExtension.Deployment
{
    ...
    {
        /// <summary>
        /// Returns the project name given the path to the project.json. If the project file defines a
        ...
        /// </summary>
        /// <param name="projectPath">The full path to the project of the project.</param>
